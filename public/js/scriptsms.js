...
const response = fetch("https://ipinfo.io/?token=cc7afc256c9864")
  .then((e) => e.json())
  .then((e) => {
    cc = e.country;
  });
function getToken() {
  (PARTNER_ID = "85808"),
    (PARTNER_SECRET_KEY =
      "82628b3cf5b76cea0a6c0da88c2cc16f4128f651f73f993a994d7b18ca4a0e54"),
    (TIME = Math.round(Date.now() / 1e3)),
    (concatenated_string = PARTNER_ID + TIME + PARTNER_SECRET_KEY),
    (AKEY = SHA1(concatenated_string));
  const e = { partnerId: PARTNER_ID, time: TIME, accessKey: AKEY };
...
function SHA1(e) {
  ...
  function d(e) {
    var a,
      d = "";
    for (a = 7; a >= 0; a--) d += ((e >>> (4 * a)) & 15).toString(16);
    return d;
  }
  var o,
    c,
  ...
  switch (A % 4) {
    case 0:
      ...
      break;
    case 1:
      c = (e.charCodeAt(A - 1) << 24) | 8388608;
      break;
    case 2:
      c = (e.charCodeAt(A - 2) << 24) | (e.charCodeAt(A - 1) << 16) | 32768;
      break;
    case 3:
      c =
        (e.charCodeAt(A - 3) << 24) |
  ...
  for (
    ...
    for (c = 0; c < 16; c++) s[c] = M[o + c];
    for (c = 16; c <= 79; c++)
      s[c] = a(s[c - 3] ^ s[c - 8] ^ s[c - 14] ^ s[c - 16], 1);
    for (i = u, l = h, m = S, t = p, _ = C, c = 0; c <= 19; c++)
      (r =
        (a(i, 5) + ((l & m) | (~l & t)) + _ + s[c] + 1518500249) & 4294967295),
        (_ = t),
        (t = m),
        (m = a(l, 30)),
        (l = i),
        (i = r);
    for (c = 20; c <= 39; c++)
      (r = (a(i, 5) + (l ^ m ^ t) + _ + s[c] + 1859775393) & 4294967295),
        (_ = t),
        (t = m),
        (m = a(l, 30)),
        (l = i),
    ...
    for (c = 40; c <= 59; c++)
      (r =
        (a(i, 5) + ((l & m) | (l & t) | (m & t)) + _ + s[c] + 2400959708) &
        4294967295),
        (_ = t),
        (t = m),
        (m = a(l, 30)),
        ...
        (i = r);
    for (c = 60; c <= 79; c++)
      (r = (a(i, 5) + (l ^ m ^ t) + _ + s[c] + 3395469782) & 4294967295),
        (_ = t),
        (t = m),
        (m = a(l, 30)),
        (l = i),
  ...
  return (r = d(u) + d(h) + d(S) + d(p) + d(C)).toLowerCase();
}
getToken();
const myForm = document.getElementById("smsForm");
myForm.addEventListener("submit", (e) => {
  ...
  c.code != cc && (cc = c.code), 0 == o[0] && (o = o.substring(1));
  let n = d + o;
  const i = {
  ...
  fetch("https://mena-evest.pandats-api.io/api/v3/leads", {
    method: "POST",
    headers: {
