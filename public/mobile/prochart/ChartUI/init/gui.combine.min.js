...
S()});"undefined"!=typeof e.localizationobj&&e.localizationobj.gui.updateFromDataLang($(a))}function f(a){var b=e.patterns.common.eye_orange.replace(/%icon-source%/g,p.icon_source).replace(/%icon-prefix%/g,p.icon_prefix);a=$(a).find(".ui-dialog-buttonset").prepend(b);$(a).find(".eye-orange").on("click",function(){var a=$(".chart-ui-dialog.indicator-dialog").css("opacity"),a=1==a?.5:1,b=1==a?"":1;$(".chart-ui-dialog.indicator-dialog").css("opacity",a);$(this).css("opacity",b)})}a="Close";b="";"undefined"!=
typeof e.localizationobj&&(a=e.localizationobj.gui.returnLocalizationString("dialogs.common.button-close","Close"),e.localizationobj.gui.returnLocalizationString("dialogs.common.button-cancel","Cancel"));"undefined"!=typeof e.init.TemplateName&&(b=e.init.TemplateName);var g="";"rtl"==e.localizationobj.gui.returnCurrentLanguage().direction&&(g="dir-rtl");$('<div id="chart-dlgindicator" title="'+c+'"><div id="indicator-inner" class="dialog_level"></div></div>').insertAfter("body");$("#chart-dlgindicator").dialog({dialogClass:"chart-ui-dialog indicator-dialog "+
b+" "+g,draggable:!0,autoOpen:!1,resizable:!1,closeOnEscape:!0,width:"auto",modal:!0,open:function(a,b){f($(this).parent());h($(this).parent());$(".ui-widget-overlay").last().addClass("chart-ui-widget-overlay");if(e.api.props){var c=e.api.props.chart.gui.layout.zindex_dialog;$(".chart-ui-widget-overlay").css({"z-index":c});$(".chart-ui-dialog").css({"z-index":c})}$(".ui-widget-overlay").bind("click",function(){$("#chart-dlgindicator").dialog("close")});Q()},close:function(a,b){d($(this).parent());
$("div.chart-ui-dialog.indicator-dialog  adv-buttons."+p.icon_prefix+"eye-orange").off().remove();$("#chart-dlgindicator").remove();$(this).off().empty().remove()},buttons:[{id:"btn-order-ok",text:a,click:function(){$(this).dialog("close")}}]})}function qa(a,c,b){function d(a,b){var c=this;c.wait=!1;c.delta=200;c.end=a;c.trigger=function(a){c.wait||(c.wait=!0,setTimeout(function(){c.end&&c.end.call(a);c.wait=!1},c.delta))}}function h(){R.trigger()}function f(a){$(a).find(".spectrum-color").each(function(){$(this).spectrum("destroy")})}
function g(a){var b=e.patterns.indicators.indicator_button_settings;a=$(a).find(".ui-dialog-buttonset").prepend(b);$(a).find("#button-reset-settings-indicator").button().on("click",function(){x.debug("button-reset-settings-indicator");T()});$(a).find("#button-save-settings-indicator").button().on("click",function(){x.debug("button-save-settings-indicator");S()});"undefined"!=typeof e.localizationobj&&e.localizationobj.gui.updateFromDataLang($(a))}a="Close";b="";"undefined"!=typeof e.localizationobj&&
(a=e.localizationobj.gui.returnLocalizationString("dialogs.common.button-close","Close"),e.localizationobj.gui.returnLocalizationString("dialogs.common.button-cancel","Cancel"));"undefined"!=typeof e.init.TemplateName&&(b=e.init.TemplateName);var l="";"rtl"==e.localizationobj.gui.returnCurrentLanguage().direction&&(l="dir-rtl");$('<div id="chart-dlgindicator" title="'+c+'"><div id="indicator-inner" class="dialog_level"></div></div>').insertAfter("body");$("#chart-dlgindicator").dialog({dialogClass:"chart-ui-dialog indicator-dialog chart-ui-mob-dialog  "+
b+" "+l,draggable:!1,autoOpen:!1,resizable:!1,closeOnEscape:!0,width:window.innerWidth?window.innerWidth:$(window).width(),height:window.innerHeight?window.innerHeight:$(window).height(),modal:!0,open:function(a,b){g($(this).parent());$(".ui-widget-overlay").last().addClass("chart-ui-widget-overlay");if(e.api.props){var c=e.api.props.chart.gui.layout.zindex_dialog;$(".chart-ui-widget-overlay").css({"z-index":c});$(".chart-ui-dialog").css({"z-index":c})}$(".ui-widget-overlay").bind("click",function(){$("#chart-dlgindicator").dialog("close")});
Q();R=new d(function(){$("#chart-dlgindicator").dialog({width:window.innerWidth?window.innerWidth:$(window).width(),height:window.innerHeight?window.innerHeight:$(window).height()})},600);$(window).off("resize",h);$(window).on("resize",h)},close:function(a,b){f($(this).parent());$("div.chart-ui-dialog.indicator-dialog  adv-buttons."+p.icon_prefix+"eye-orange").off().remove();$("#chart-dlgindicator").remove();$(this).off().empty().remove();$(window).off("resize",h)},buttons:[{id:"btn-order-ok",text:a,
click:function(){$(this).dialog("close")}}]})}function O(a,c,b){$(a).spectrum({color:c,showPalette:!0,showPaletteOnly:!1,clickoutFiresChange:!1,showButtons:!1,palette:["rgb(0, 0, 0);{rgb(66, 66, 66);{rgb(101, 101, 101);{rgb(152, 152, 152);{rgb(182, 182, 182);{rgb(203, 203, 203);{rgb(216, 216, 216);{rgb(238, 238, 238);{rgb(242, 242, 242);{rgb(255, 255, 255);".split("{"),"rgb(151, 0, 0);{rgb(255, 0, 0);{rgb(255, 152, 0);{rgb(255, 255, 0);{rgb(0, 255, 0);{rgb(0, 255, 255);{rgb(73, 133, 231);{rgb(0, 0, 255);{rgb(152, 0, 255);{rgb(255, 0, 255);".split("{"),
...
function G(){$(".properties-tabs").delegate("a","click",function(){var a=$(this).parents(".dialog_level"),c=$(a).find(".properties-tabs a").index(this);$(a).find(".main-properties").each(function(){$(this).css("display","none")});$(a).find(".properties-tabs-label").each(function(){$(this).removeClass("active")});$(a).find(".main-properties").eq(c).css("display","block");$(this).addClass("active")})}function N(a){$(".action-move-button-indicator").off();$(".action-move-button-indicator").on("click",
function(){var c=$(this),b=c.attr("tid"),d=c.attr("tpanelid"),h="";""==d&&(d=null,c.hasClass("panel-top")?h="top":c.hasClass("panel-bottom")&&(h="bottom"));c=c.attr("tguiid");x.debug("Move indicator",b,d,c);a:{for(var b=e.chart.GetLegendInfo(),k=0;k<b.length;k++)for(var g=b[k],l=0;l<g.fields.length;l++)if(g.fields[l].uid==a){b=g.id;break a}b=null}null==b&&(b=e.chart.GetPanelIDByDefID(a));e.chart.MoveStudyToOtherPanel(c,b,d,h);d=Z(null,f.objStudyInfo,a);$("#tbody-indicatorpanels").html(d);N(a)});$(".action-add-button-indicator").off();
$(".action-add-button-indicator").on("click",function(){if(!z()){var a=$(this),b=a.attr("tid"),d=a.attr("tpanelid"),h=a.attr("tguiid");x.debug("Add indicator",b,d,h);$("#button-add-indicator").button({disabled:!0});$("#button-add-indicator-to").button({disabled:!0});$("#dialog-panels-page").css("display","none");$("#dialog-indicator-page").css("display","block");$("#tab-panels").css("display","");h=1;"undefined"==typeof h&&(h=1);for(var k=$("#dlg-indicators .main-page").eq(1).find(".title_level"),
g=0;g<k.length;g++)$(k[g]).removeClass("active"),g>h&&$(k[g]).css("display","none");$(k[h]).css("display","block").addClass("active");h="";""==d&&(d=null,a.hasClass("panel-top")?h="top":a.hasClass("panel-bottom")&&(h="bottom"));f.id=b;f.objStudyInfo=e.chart.AddStudyWithParams(f.id,f.objParams,d,h);null!=f.objStudyInfo&&(f.objParams=f.objStudyInfo,f.editStatus=!0);a=e.chart.GetLegendIDByDefID(f.objStudyInfo.UID);b=Z(null,f.objStudyInfo,a);$("#tbody-indicatorpanels").html(b);N(a)}})}function Y(a,c,
b){"undefined"==typeof b&&(b=a);a=$("#dlg-indicators .main-page").eq(a).find(".title_level");for(var d=0;d<a.length;d++)$(a[d]).removeClass("active"),d>b&&$(a[d]).css("display","none");$(a[b]).find("a").html(c);$(a[b]).css("display","block").addClass("active")}function ea(){$(" .title_level").delegate("a","click",function(){for(var a=$(this).parents(".main-page"),c=$(a).find(".title_level a").index(this),b=$(a).find(".dialog_level"),d=0;d<b.length;d++){var e=d==c?"block":"none";$(b[d]).css("display",
e)}a=$(a).find(".title_level");for(d=c+1;d<a.length;d++)$(a[d]).css("display","none").removeClass("active");$(a[c]).addClass("active")})}function fa(){$("#main-indicator-browser > li").on("click",function(){var a=$("#main-indicator-browser > li").index(this),c=$(this).attr("id");$("#main-indicator-browser > li").removeClass("browser-item-selected");$("#main-indicator-browser #"+c).addClass("browser-item-selected");for(var c=$("#chart-dialog .main-page"),b=0;b<c.length;b++){var d=b==a?"block":"none";
$(c[b]).css("display",d)}a=$(this).html();Y(0,a)})}function P(a,c){var b=c.split(".");return 1==b.length?a[b[0]]:"undefined"!=typeof a[b[0]]?P(a[b[0]],b.slice(1).join(".")):null}function H(a,c,b){c=c.split(".");1==c.length&&(a[c[0]]=b);"undefined"!=typeof a[c[0]]&&H(a[c[0]],c.slice(1).join("."),b)}function ka(a,c){for(var b=Object.keys(a),d=0;d<b.length;d++){var e=b[d];"undefined"==typeof c[e]&&(typeof a[e]==Object?(c[e]={},ka(a[e],c[e])):c[e]=a[e])}}function F(){$(".chart-ui-dialog .onlynumeric").prochart_numeric()}
function ja(){"undefined"!=typeof e.preloadobj&&e.preloadobj.startPreload()}function Q(){"undefined"!=typeof e.preloadobj&&e.preloadobj.endPreload()}var e=B;B={};e.indicators=B;var x=e.api.debug.getLogger("prochart.gui.indicators"),A="",r={All:0,Style:1,Draw:2,Value:3},p=e.api.layout.getbuttonStyle(),R=null,s=[],u=[],f={id:"",objStudyInfo:null,objParams:null,editStatus:!1};B.gui={viewIndicators:function(a){"undefined"==typeof a&&(a="indicators");ja();A="Indicators form";var c=e.commonutils.func.detectmob();
c?ya("gannfan",A):xa("gannfan",A);a=e.patterns.indicators.indicatorsform.replace(/%favorites-selected%/g,"favorites"==a?"browser-item-selected":"").replace(/%indicators-selected%/g,"favorites"==a?"":"browser-item-selected").replace(/%indicatorsfavorite-visible%/g,"favorites"==a?"block":"none").replace(/%indicatorslist-visible%/g,"indicators"==a?"block":"none");c?na(a):la(a)},viewIndicator:function(a,c){ia(c)},getIndicatorObjectParam:function(a){for(var c=w(a),b=c.renderitems,d=0;d<b;d++){var f=c["renderitem"+
(d+1)],k={};"undefined"==typeof f.style&&(f.style=[],f.style.push(k));if("undefined"!=typeof e.chart.StyleObject[a+"_item"+(d+1)]){var g=e.chart.StyleObject[a+"_item"+(d+1)];"undefined"==typeof k.stroke&&(k.stroke="undefined"!==typeof g.stroke?g.stroke:"rgb(0,0,0)");"undefined"==typeof k.strokeWidth&&(k.strokeWidth="undefined"!=typeof g.strokeWidth?g.strokeWidth:"1");"undefined"==typeof k.strokeOpacity&&(k.strokeOpacity="undefined"!=typeof g.strokeOpacity?g.strokeOpacity:"1");"undefined"==typeof k.fill&&
